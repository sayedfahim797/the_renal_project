<header class="header dark-bg">
    ...
    <!--logo start-->
    <a href="{{ route('staff') }}" class="logo">ATRYT.<span>[Staff]</span></a>
    <!--logo end-->
    <div class="top-nav ">
        ...
        <ul class="nav pull-right top-menu">
            ...
            <li class="dropdown">
                ...
                <ul class="dropdown-menu extended logout dropdown-menu-right">
                    ...
                    <li><a href="{{ route('staffProfile') }}"><i class=" fa fa-suitcase"></i>Profile</a></li>
                    <li><a href="#"><i class="fa fa-cog"></i> Settings</a></li>
                    <li><a href="{{ route('staffPasswordChange') }}"><i class="fa fa-key"></i> C. Password</a></li>
                    <li>
