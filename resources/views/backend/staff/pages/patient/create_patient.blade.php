...
@section('backend-title')
  <title>Add Patient | Atrytech Information Technology</title>
@endsection
    ...
    <div class="col-lg-12">
        <section class="card">
            <header class="card-header bg-success text-light">
                 <center><b style="font-family: Algerian; font-size: 17px;"><i class="fa fa-plus-circle"></i> Add Patient</b></center>
            </header>
            <div class="card-body">
               <div class="form">
                  <form action="{{ route('storePatients') }}" method="post" id="myForm">
                    @csrf
                    <div class="row">
                      <div class="col-md-4"> 
                      ...
                      <div class="col-md-6"> 
                          <div class="form-group"> 
                              ...
                              <div class="input-group date dpYears" data-date-viewmode="years" data-date-format="dd-mm-yyyy" data-date="01-01-2021">
                                <input type="text" name="dob" id="dob" class="form-control" aria-label="Right Icon" aria-describedby="dp-ig" placeholder="DD-MM-YYYY">
                    ...
                    <div class="row">
                      ...
                      <div class="form-group pull-right">
                           <button class="btn btn-success" id="storeButton" type="submit"><i class="fa fa-cloud-upload"> Upload</i></button>
                        </div>
                        </div>
                    </div>
                  </form>
