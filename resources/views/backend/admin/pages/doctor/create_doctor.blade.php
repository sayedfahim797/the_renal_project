...
@section('backend-title')
  <title>Add Doctor | Atrytech Information Technology</title>
@endsection
    ...
    <div class="col-lg-12">
        <section class="card">
            <header class="card-header bg-success text-light">
                 <center><b style="font-family: Algerian; font-size: 17px;"><i class="fa fa-plus-circle"></i> Add Doctor</b></center>
            </header>
            <div class="card-body">
               <div class="form">
                  <form action="{{ route('storeDoctors') }}" method="post" enctype="multipart/form-data" id="myForm">
                    @csrf
                    <div class="row">
                      <div class="col-md-6"> 
