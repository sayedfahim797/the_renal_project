...
@section('backend-title')
  <title>Update Doctor | Atrytech Information Technology</title>
@endsection
    ...
    <div class="col-lg-12">
        ...
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb pull-right">
                <a href="{{ route('viewDoctors') }}" class="btn btn-info btn-sm" style="font-family: Kufam;"><i class="fa fa-eye"></i> View Doctor</a>
            </ol>
        </nav>
        <!--breadcrumbs end -->
    </div>
    ...
    <div class="col-lg-12">
        <section class="card">
            <header class="card-header bg-primary text-light">
                 <center><b style="font-family: Algerian; font-size: 17px;"><i class="fa fa-location-arrow"></i> Update Doctor</b></center>
            </header>
            <div class="card-body">
               <div class="form">
                  <form action="{{ route('updateDoctors', $allData->id) }}" method="post" enctype="multipart/form-data" id="myForm">
                    @csrf
                    <div class="row">
                      <div class="col-md-6"> 
                          <div class="form-group"> 
                              ...
                              <select name="role_id" class="select2">
                                ...
                                <option value="2" {{($allData->role_id==2)?"selected":""}}>Doctor</option>
                              </select> 
                          </div> 
                      </div>
                      <div class="col-md-6"> 
